...
export function SellerDashboard({ activeTab, isSeller }: SellerDashboardProps) {
  ...
  const { 
    reads: { useProductCount, useOrderCount, useProducts, useProduct, useOrder, useBuyerOrders, useSellerOrders, useSellerProducts, useIsSeller, useSeller, useEscrowContract, useOwner: useMarketplaceOwner, useEscrowToOrder },  
